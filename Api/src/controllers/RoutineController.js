...
export const postRoutineController = async (name, description, objetive, target_time, initial_weight, actual_weight, target_weight, emailPersonalTrainer) => {
    try {
        ...
        const newRoutine = await Routine.create({ name,description, objetive, target_time, initial_weight, actual_weight, target_weight, PersonalTrainerId})
