...
// })
export const DayExercise = initDayExercise(sequelize)
DayModule.belongsToMany(Exercise, { through: 'DayExercise', foreignKey: 'dayModuleId' })
Exercise.belongsToMany(DayModule, { through: 'DayExercise', foreignKey: 'exerciseId'})
